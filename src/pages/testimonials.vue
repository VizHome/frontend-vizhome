      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <Card class="overflow-hidden h-full">
            <div class="md:flex h-full">
              <div class="md:w-2/5 bg-muted">
                <img src="/images/docs/projet_1.png" alt="Témoignage de Mathilde Laurent"
          ...
          <Card class="overflow-hidden h-full">
            <div class="md:flex h-full">
              <div class="md:w-2/5 bg-muted">
                <img src="/images/docs/projet_1.png" alt="Témoignage de Thomas Moreau"
                  class="w-full h-full object-cover" />
              </div>
              <div class="md:w-3/5 p-6 flex flex-col">
                <div class="mb-4 flex items-center gap-2">
        ...
        <div class="text-center mt-12">
          <Button variant="outline" @click="loadMore" class="gap-1" v-if="!allLoaded">
        ...
        <Card>
          <CardContent class="pt-6 pb-6">
            <div class="md:flex items-center gap-8">
              ...
              <div class="md:w-1/2">
                <img src="/images/docs/projet_1.png" alt="Demandez une démo"
