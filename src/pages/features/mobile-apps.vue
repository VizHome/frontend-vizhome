<template>
    <div>
        ...
        <section class="pt-20 pb-12 bg-muted/30">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <Badge class="mb-4">Mobilité</Badge>
                        <h1 class="text-4xl font-bold mb-6">Applications mobiles</h1>
                        <p class="text-xl text-muted-foreground mb-6">
                            Emportez VizHome partout avec vous grâce à nos applications mobiles pour iOS et Android.
                            Créez, visualisez et partagez vos projets 3D où que vous soyez.
                        </p>
                        <div class="flex flex-wrap gap-4">
                            <Button size="lg" as-child class="gap-2">
        ...
        <section class="py-16">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold mb-12 text-center">Fonctionnalités principales</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                    <Card>
                        <CardHeader>
                            ...
                            <CardTitle>Capture rapide</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p class="text-muted-foreground">
                                Prenez une photo avec votre téléphone et transformez-la instantanément en modèle 3D
                                grâce à notre IA mobile.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            <div class="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-3">
                                <Smartphone3dIcon class="h-6 w-6 text-primary" />
                            </div>
                            <CardTitle>Visualisation AR</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p class="text-muted-foreground">
                                Visualisez vos projets en réalité augmentée directement dans votre environnement
                                physique pour une expérience immersive.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            <div class="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-3">
                                <CloudIcon class="h-6 w-6 text-primary" />
                            </div>
                            <CardTitle>Synchronisation cloud</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p class="text-muted-foreground">
                                Tous vos projets sont automatiquement synchronisés entre vos appareils pour un accès
                                transparent où que vous soyez.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p class="text-muted-foreground">
                                Prenez des notes et faites des croquis directement sur site, puis intégrez-les à vos
                                projets 3D pour une référence rapide.
                            </p>
                        </CardContent>
                    </Card>
                </div>
        ...
        <section class="py-16">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold mb-6 text-center">Expérience de réalité augmentée</h2>
                <p class="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
                    Visualisez vos projets dans le monde réel avec notre technologie de réalité augmentée avancée
                </p>
                ...
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                        <div class="bg-muted/30 p-4 rounded-lg">
                            ...
                            <h3 class="font-medium mb-2">Scan de l'environnement</h3>
                            <p class="text-sm text-muted-foreground">
                                L'application analyse automatiquement l'espace pour placer les objets de manière
                                réaliste.
                            </p>
                        </div>
                        ...
                        <div class="bg-muted/30 p-4 rounded-lg">
                            <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-3">
                                <HandIcon class="h-5 w-5 text-primary" />
                            </div>
                            <h3 class="font-medium mb-2">Manipulation intuitive</h3>
                            <p class="text-sm text-muted-foreground">
                                Déplacez, tournez et redimensionnez les modèles avec des gestes naturels.
                            </p>
                        </div>
                        ...
                        <div class="bg-muted/30 p-4 rounded-lg">
                            ...
                            <h3 class="font-medium mb-2">Capture d'écrans AR</h3>
                            <p class="text-sm text-muted-foreground">
                                Prenez des photos ou des vidéos de vos projets intégrés dans l'environnement réel.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-16 bg-muted/30">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold mb-12 text-center">Ce que disent nos utilisateurs</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    <Card>
                        <CardContent class="pt-6">
                            ...
                            <blockquote class="italic text-muted-foreground mb-6">
                                "L'application mobile VizHome est devenue mon outil indispensable sur les chantiers. Je
                                peux scanner un espace et présenter immédiatement des options de design à mes clients."
                            </blockquote>
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="font-medium">Julien Durand</h3>
                    ...
                    <Card>
                        <CardContent class="pt-6">
                            ...
                            <blockquote class="italic text-muted-foreground mb-6">
                                "La fonction de réalité augmentée est incroyable. Mes clients peuvent littéralement voir
                                leur future maison avant même qu'elle ne soit construite. Un outil de vente puissant."
                            </blockquote>
                            <div class="flex items-center gap-4">
                                <Avatar>
                                ...
                                <div>
                                    <h3 class="font-medium">Emma Martin</h3>
                    ...
                    <Card>
                        <CardContent class="pt-6">
                            ...
                            <blockquote class="italic text-muted-foreground mb-6">
                                "La synchronisation avec la version desktop est parfaite. Je commence un projet au
                                bureau et je peux le continuer en déplacement sans aucune difficulté."
                            </blockquote>
                            <div class="flex items-center gap-4">
                                <Avatar>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-muted-foreground">Designer d'espace</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
            ...
            <div class="container mx-auto px-4">
                <div
                    ...
                    <p class="text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Disponible sur iOS et Android, notre application vous permet d'emporter VizHome partout avec
                        vous.
                    </p>
                    ...
                    <p class="text-sm text-muted-foreground mt-6">
                        Nécessite iOS 14.0+ ou Android 9.0+. Connexion Internet requise pour certaines fonctionnalités.
                    </p>
                </div>
            </div>
        </section>
...
import { AppleIcon, SmartphoneIcon, CameraIcon, CloudIcon, NotebookIcon, CheckIcon, Play, ScanIcon, HandIcon, StarIcon } from 'lucide-vue-next'
