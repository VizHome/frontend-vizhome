    ...
    <div class="hidden md:block">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          >
            <span class="h-4 w-4 text-sm flex items-center justify-center"
              >🇫🇷</span
            >
            <span>Français</span>
            <CheckIcon
      ...
      <Dialog v-model:open="isMobileMenuOpen">
        <DialogContent class="max-w-xs mx-auto">
          <DialogHeader>
            ...
            <DialogDescription
              >Sélectionnez la langue de l'interface</DialogDescription
            >
          </DialogHeader>
...
const displayLanguage = computed(() => {
  return (
    languages[currentLanguage.value as keyof typeof languages]?.label || 'FR'
  )
})
