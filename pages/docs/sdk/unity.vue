  ...
  <div class="space-y-8">
    ...
    <Card>
      <CardContent class="pt-6">
        <p>
          Le SDK Unity VizHome vous permet d'intégrer facilement notre
          plateforme de visualisation 3D dans vos applications, jeux et
          expériences créés avec Unity. Parfait pour les applications
          immobilières, les expériences VR/AR et la visualisation
          architecturale.
        </p>
      </CardContent>
    </Card>
        ...
        <CardContent class="pt-6">
          <div class="space-y-6">
            <div>
              ...
              <p class="mb-2">
                Ajoutez le package en utilisant le Package Manager d'Unity avec
                notre URL Git :
              </p>
              ...
              <ol class="list-decimal pl-6 mb-4 space-y-2">
                <li>
                  Ouvrez Unity et accédez à
                  <strong>Window > Package Manager</strong>
                </li>
                <li>
                  Cliquez sur le bouton <strong>+</strong> et sélectionnez
                  <strong>Add package from git URL</strong>
                </li>
                <li>
                  Collez l'URL ci-dessus et cliquez sur <strong>Add</strong>
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <p class="mb-2">
                Alternativement, vous pouvez télécharger le package depuis notre
                portail développeur :
              </p>
              <ol class="list-decimal pl-6 mb-4 space-y-2">
                <li>
                  ...
                  <a href="#" class="text-primary hover:underline"
                    >VizHome-Unity-SDK.unitypackage</a
                  >
                </li>
                <li>
                  Dans votre projet Unity, accédez à
                  <strong>Assets > Import Package > Custom Package</strong>
                </li>
                <li>
                  Sélectionnez le fichier téléchargé et cliquez sur
                  <strong>Open</strong>
                </li>
                <li>
                  Assurez-vous que tous les éléments sont sélectionnés et
                  cliquez sur
    ...
    <div>
      ...
      <Card>
        <CardContent class="pt-6">
          <div class="space-y-6">
            <p>
              Notre SDK Unity est optimisé pour les expériences VR et AR,
              permettant une visualisation immersive des modèles 3D dans les
              applications XR.
            </p>

            <div>
              <h3 class="text-lg font-medium mb-2">
                Configuration VR avec Unity XR Interaction Toolkit
              </h3>
              <div class="relative">
                <pre class="bg-muted text-sm rounded-md p-4 overflow-x-auto">
                  <code>
...
public class VRModelViewer : MonoBehaviour
{
    ...
    private void SetupVRInteractions(GameObject model)
    {
        ...
        grabInteractable.selectExited.AddListener((args) => {
            ...
            <div>
              <h3 class="text-lg font-medium mb-2">
                Intégration AR avec AR Foundation
              </h3>
              <div class="relative">
                <pre class="bg-muted text-sm rounded-md p-4 overflow-x-auto">
                  <code>
      ...
      <Card>
        <CardContent class="pt-6">
          <div class="space-y-6">
            <div>
              <h3 class="text-lg font-medium mb-2">
                Annotations et points d'intérêt
              </h3>
              <div class="relative">
                <pre class="bg-muted text-sm rounded-md p-4 overflow-x-auto">
                  <code>
...
public class MaterialCustomizer : MonoBehaviour
{
    ...
    <div>
      <h2 class="text-2xl font-bold mb-4">
        Exemple complet d'une application immobilière
      </h2>
      <Card>
        <CardContent class="pt-6">
          <p class="mb-4">
            L'exemple suivant montre comment créer une application immobilière
            complète avec navigation entre les propriétés, visualisation en VR
            et fonctions de personnalisation.
          </p>
          ...
          <div class="flex flex-col lg:flex-row gap-4 mb-6">
            <div class="lg:w-1/2">
              <img
                ...
                alt="Exemple d'application Unity"
            ...
            <div class="lg:w-1/2">
              <img
                src="/images/generate/image_generate.png"
                alt="Exemple d'application Unity en VR"
                class="rounded-md border w-full h-auto"
              />
            </div>
          </div>
          ...
          <Alert variant="info">
            ...
            <AlertDescription>
              <p class="mb-2">
                Nous proposons un projet Unity complet démontrant l'intégration
                du SDK VizHome :
              </p>
