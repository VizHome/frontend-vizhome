              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  ...
                  >
                    <Fence class="h-4 w-4" />
                    <span
                      >{{ showFence ? 'Masquer' : 'Afficher' }} clôture</span
                    >
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                ...
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    <span
                      >{{ showGarden ? 'Masquer' : 'Afficher' }} jardin</span
                    >
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    <span
                      >{{ showFog ? 'Masquer' : 'Afficher' }} brouillard</span
                    >
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  ...
                  >
                    <Wind class="h-4 w-4" />
                    <span
                      >{{ treeAnimation ? 'Arrêter' : 'Démarrer' }} vent</span
                    >
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    />
                    <div class="text-center text-xs text-muted-foreground">
                      {{ Math.round(audioVolumeArray[0] * 100) }}%
                    </div>
                  </div>
                </SidebarMenuItem>
              </SidebarMenu>
                    ...
                    >
                      ...
                      <div class="space-y-2">
                        ...
                        <Slider
                          ...
                          class="w-full"
                          @update:model-value="updateModelScale($event[0])"
                        />
                        <div class="text-center text-xs text-muted-foreground">
...
const createFence = () => {
  ...
  for (let x = -12; x <= 12; x += postSpacing) {
    ...
    if (Math.abs(x) > 4) {
      // Laisser une ouverture devant la maison
